...
<coral-select name="multifield-select" disabled="true" class="multifield-select-item multifield-select-<%= xssAPI.encodeForHTMLAttr(key) %>" placeholder="Select number of field">
